...
Perception, Action, and Development Lab members authored a new article in the journal *Infancy*. The article, *Walking-related changes in infants’ everyday experiences of postural transitions: A longitudinal assessment*, was authored by PADLAB doctoral student [Yushan Gyo](/people/yushan-guo.qmd), former PADLAB staff member Maximilian Tang, and [John Franchak](/people/john-franchak.qmd). An open-access PDF is available on the [publications page](/Publications.qmd).

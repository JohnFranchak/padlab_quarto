...
![Figure. Faces vary over time in how salient (shaded areas) and centered (orange lines) they are in a scene.](/posts/2022-infancy-images/face-example.png){width="75%"}
...
![Figure. Model estimates showing whether saliency/centering increased the likelihood of face looking within each age group.](/posts/2022-infancy-images/result.png){width="85%"}

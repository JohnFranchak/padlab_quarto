...
To accomplish these aims, I develop new technological and computational approaches to studying behavior, such as creating a machine-learning classification system for automatically measuring infants' body position in the home from wearable inertial sensors and pioneering the first mobile eye-tracking method for studying infants’ naturalistic visual exploration.
